...
public class AtendimentoControllerTest {
    ...
    public void testAtendimentoControllerGetAll() throws Exception{
        ...
        mock.perform(MockMvcRequestBuilders.get("/atendimento/")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.jsonPath("$[0].id", Matchers.is(1)));
    ...
    public void testAtendimentoControllerGetById() throws Exception{
        ...
        mock.perform(MockMvcRequestBuilders.get("/atendimento/1")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.jsonPath("$.profissional.nome", Matchers.is("Luis")));
    }
}
